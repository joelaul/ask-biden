...
const repopulateJoeBubbles = ()=>{
    for(let i = 0; i < joeBubbleDivs.length; i++)joeBubbleDivs[i].addEventListener("click", ()=>{
...
const handleAsk = async (prompt)=>{
    if (textArea.value.length > 0 && !throttleTimer) {
        ...
        if (usedPrompts[prompt]) audio.src = usedPrompts[prompt][0];
        else {
...
// INIT
const init = ()=>{
    for (let suggestion of suggestions)suggestion.addEventListener("click", ()=>{
...
init(); // KEEP CHAT STATE AND SEND IN REQUEST TO BACKEND
 // CLEAR CHAT STATE ON RELOAD
 // DONATE SUGGESTION AFTER X PROMPTS
 // RESPONSIVE DESIGN (FORK ME Z-INDEX LOL)
 // REMOVE FUNNY BUSINESS - BRANCH OR CLONE REPO?
        ...
        return function() {
            ...
            if (!isWorker && canUseWorker) {
                ...
                try {
                    ...
                    (console, typeof console.warn === "function") && console.warn("\uD83C\uDF8A Could not load worker", e);
                    return null;
                }
                decorate(worker);
            }
...
const confettiSoundUrl = require("6117a76e1d81373c");
const confettiSound = new Audio(confettiSoundUrl);
const listenStartSoundUrl = require("ec3f3e685f4f5871");
const listenStartSound = new Audio(listenStartSoundUrl);
const listenStopSoundUrl = require("e1524bee90c888b8");
...
},{"bd01df31efb72975":"jhGta","67c42ec3f674e953":"41P8L","6117a76e1d81373c":"dNvVL","ec3f3e685f4f5871":"8ZUWr","e1524bee90c888b8":"5sb2Z"}],"jhGta":[function(require,module,exports) {
module.exports = require("4635ac4fdadd41b8").getBundleURL("1G2bZ") + "sent.696b593f.mp3" + "?" + Date.now();

},{"4635ac4fdadd41b8":"lgJ39"}],"lgJ39":[function(require,module,exports) {
"use strict";
var bundleURL = {};
...
},{}],"41P8L":[function(require,module,exports) {
module.exports = require("b7ed680c79775a75").getBundleURL("1G2bZ") + "suggestion.8556bfe7.wav" + "?" + Date.now();

},{"b7ed680c79775a75":"lgJ39"}],"dNvVL":[function(require,module,exports) {
module.exports = require("cb1c26b5617c724a").getBundleURL("1G2bZ") + "confetti.10b7f68d.wav" + "?" + Date.now();

},{"cb1c26b5617c724a":"lgJ39"}],"8ZUWr":[function(require,module,exports) {
module.exports = require("e60ad768ca616ff5").getBundleURL("1G2bZ") + "listenStart.1e0ad212.wav" + "?" + Date.now();

},{"e60ad768ca616ff5":"lgJ39"}],"5sb2Z":[function(require,module,exports) {
module.exports = require("f63452278f7b36f8").getBundleURL("1G2bZ") + "listenStop.5445e571.wav" + "?" + Date.now();

},{"f63452278f7b36f8":"lgJ39"}]},["2waQk","igcvL"], "igcvL", "parcelRequiree8ef")
